...
Config load_config(const std::string& path)
{
    ...
    cfg.dir.results_root = config["results_root"].as<std::string>();
    cfg.dir.data_root = config["data_root"].as<std::string>();
    cfg.dir.source_root = config["source_root"].as<std::string>();
    cfg.dir.system_identifier = config["system_identifier"].as<std::string>();
